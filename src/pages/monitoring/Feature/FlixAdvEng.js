    ...
    function Solution() {
      ...
      const cardsData = [
        {
          image: Im1,
          title: "Zotërimi i gramatikës dhe fjalorit",
          description: "Forconi bazën e anglishtes me gramatikë të avancuar dhe fjalor thelbësor.",
        },
        {
          image: Im2,
          title: "Komunikim në Biznes",
          description: " Mësoni të komunikoni në mënyrë efektive në një ambient korporativ.",
        },
        {
          image: Im3,
          title: "Të folurit në publik dhe prezantime",
          description: "Fitoni vetëbesim për të folur qartë dhe rrjedhshëm para çdo audience.",
        },
    
        {
          image: Im5,
          title: "Përgatitje për intervista",
          description: "Mësoni si të bëheni ekspertë për intervista, nëpërmjet këshillave profesionale dhe seancave praktike.",
        },
    
        {
          image: Im6,
          title: "Certifikim ndërkombëtar",
          description:
            "Merrni certifikata të njohura për njohuritë tuaja në anglisht.",
        },
    
        {
          image: Im7,
          title: "Mësim fleksibël",
          description: "Ndiqni mësimet online.",
        },
      ];
