      ...
      >
        ...
        <h1 className="text-6xl lg:text-3xl md:text-5xl sm:text-3xl xs:text-3xl md:text-center xs:text-start sm:text-start font-bold text-gray-800 dark:text-gray-100 mb-10">
          ...
          <span className="text-red-600 animate-pulse">
            Zotëroni mjetet e Inteligjencës Artificiale për sukses në marketingun dixhital.
          </span>{" "}
          I përshtatshëm për marketerë, freelancera, pronarë biznesesh dhe entuziastë të teknologjisë.
        </h1>
      </div>
